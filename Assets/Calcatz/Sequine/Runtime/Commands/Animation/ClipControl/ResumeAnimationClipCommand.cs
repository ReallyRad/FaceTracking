...
namespace Calcatz.Sequine {
    ...
    /// <summary>
    /// Resumes an animation (if the clip is previously paused) by specifying the animation clip asset.
    /// </summary>
    [System.Serializable]
    [RegisterCommand("Animation/Clip Control/Resume Animation Clip", typeof(SequineFlowCommandData))]
    public class ResumeAnimationClipCommand : SequineTargetCommand {
        ...
        public override void Editor_OnDrawTitle(out string _tooltip) {
            ...
            _tooltip = "Resumes an animation (if the clip is previously paused) by specifying the animation clip asset.";
        }
