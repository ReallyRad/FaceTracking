...
namespace Calcatz.Sequine {
    ...
    /// <summary>
    /// Plays an ambience from Ambience Library in Ambience channel.
    /// </summary>
    [System.Serializable]
    [RegisterCommand("Audio/Play Ambience From Library", typeof(SequineFlowCommandData))]
    public class PlayAmbienceFromLibraryCommand : PlayLoopingSoundCommand {
        ...
        public override void Execute(CommandExecutionFlow _flow) {
            ...
            AudioManager.PlayAmbience(soundId_value, restart_value, fadeDuration_value, volumeMultiplier_value);
        ...
        protected override string tooltip => "Plays an ambience from Ambience Library in Ambience channel.";
        ...
        protected override void OnDrawClipInputField() {
            ...
            if (GUI.Button(buttonRect, soundId, UnityEditor.EditorStyles.popup)) {
                var index = -1;
                var allIds = AudioConfig.GetOrCreateSettings().m_ambienceLibrary.GetAllIDs();
