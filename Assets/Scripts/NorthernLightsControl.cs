...
public class NorthernLightsControl : MonoBehaviour
{
    ...
    {
        float currentEmissionRate = Mathf.Lerp(AllVfxsControl.northernLightsInitialEmissionRate,
                                               AllVfxsControl.northernLightsFinalEmissionRate,
                                               fraction);
