...
namespace VolumetricFogAndMist {
    ...
    public partial class VolumetricFog : MonoBehaviour {
        ...
        const string VFM_BUILD_HINT = "VFMBuildHint115RC4";
...
#pragma warning restore 0162
        ...
        void UpdateScatteringData(Camera mainCamera) {
            ...
            Vector3 viewportPos = mainCamera.WorldToViewportPoint(sunSkyPos, vrOn ? Camera.MonoOrStereoscopicEye.Left : Camera.MonoOrStereoscopicEye.Mono);
            if (viewportPos.z < 0) {
                if (isOrtho) {
