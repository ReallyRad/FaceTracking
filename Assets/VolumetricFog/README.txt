...
Current version
- Shadows improvements and fixes 

v11.4
- Base Height is no longer used in fog areas. Use the transform position to control the altitude

v11.3
- Added Light Scattering Tint option

v11.2.1
- Added support for shader keywords new mechanism introduced in Unity 2021.3

v11.2
- Added blur option under Optimization settings
- Added blue noise option for jittering in shader options
- [Fix] Prevents error when assigning fog of war texture in Awake event
