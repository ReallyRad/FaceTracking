...
namespace Calcatz.CookieCutter {
    ...
    /// <summary>
    /// Compares 2 floats with certain comparator.
    /// </summary>
    public class FloatComparatorCommand : PropertyCommand {
        ...
        private static readonly Dictionary<Comparator, Func<float, float, bool>> comparatorHandlers = new Dictionary<Comparator, Func<float, float, bool>>() {
