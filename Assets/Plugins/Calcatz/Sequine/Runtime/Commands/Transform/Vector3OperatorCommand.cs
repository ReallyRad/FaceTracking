...
namespace Calcatz.Sequine {
    ...
    /// <summary>
    /// Calculates a Vector3 value by operating 2 Vector3s.
    /// </summary>
    [System.Serializable]
    [RegisterCommand("Transform/Vector3 Operator", typeof(SequineFlowCommandData))]
    [GlobalStarredCommandMenu(typeof(Vector3), new Type[] { typeof(SequineFlowCommandData) })]
    public class Vector3OperatorCommand : PropertyCommand {
        ...
        private static readonly Dictionary<Operator, Func<Vector3, Vector3, Vector3>> operatorHandlers = new Dictionary<Operator, Func<Vector3, Vector3, Vector3>>() {
            {Operator.Add,      (_a, _b) => { return _a + _b; } },
            {Operator.Subtract,(_a, _b) => { return _a - _b; } },
            {Operator.Cross, (_a, _b) => { return Vector3.Cross(_a, _b); } }
        };
        ...
        public override T GetOutput<T>(CommandExecutionFlow _flow, int _pointIndex) {
            ...
            if (inputIds[1].targetId == 0) {
                ...
                _b = GetInput<Vector3>(_flow, 1);
            }
            return (T)(object)operatorHandlers[opr](_a, _b);
        }
        ...
        public override void Editor_OnDrawContents(Vector2 _absPosition) {
            ...
            CommandGUI.DrawEnumField("", ref opr);
